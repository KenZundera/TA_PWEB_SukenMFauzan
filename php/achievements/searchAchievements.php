...
$sql = "SELECT player.*, achievements.* 

    FROM achievements, player

    WHERE achievements.id_achievements = player.id_achievements AND
       (
    ...
    ORDER BY achievements.id_achievements ASC
    ";
...
<?php else: ?>
    <table class="" cellpadding="15" cellspacing="0" id="data-table" class="data-table">
                ...
                while ($show = mysqli_fetch_array($achievements)) { ?>
                    <!-- <tbody> -->
