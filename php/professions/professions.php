...
$professions = $conn->query(
    'SELECT player.id_player, player.username, professions.* FROM professions, player WHERE professions.id_professions = player.id_professions ORDER BY professions.id_professions ASC LIMIT ' .
        $halamanawal .
        ',' .
...
<body class="p-2 hidden">
    ...
    <nav class="navbar">
      ...
      <ul>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Professions </a>
    ...
    <section class="content" id="content">
        <marquee behavior="alternate" direction=""><h1>Professions User Epic RPG</h1></marquee>
...
?>
        <div id="container1">
            <table class="" cellpadding="15" cellspacing="0" id="data-table" class="data-table">
                ...
                <?php while ($show = mysqli_fetch_array($professions)) { ?>
                    <!-- <tbody> -->
    ...
    <!-- Live Search JS -->
    <script src="searchProfessions.js"></script>
