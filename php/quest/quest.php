...
$quest = $conn->query(
    'SELECT player.id_player, player.username, quest.* FROM quest, player WHERE quest.id_quest = player.id_quest ORDER BY quest.id_quest ASC LIMIT ' .
        $halamanawal .
        ',' .
...
<body class="p-2 hidden">
    ...
    <nav class="navbar">
      ...
      <ul>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Quest </a>
    ...
    <section class="content" id="content">
        <marquee behavior="alternate" direction=""><h1>Quest User Epic RPG</h1></marquee>
...
?>
        <div id="container1">
            <table class="" cellpadding="15" cellspacing="0" id="data-table" class="data-table">
                ...
                <?php while ($show = mysqli_fetch_array($quest)) { ?>
                    <!-- <tbody> -->
    ...
    <!-- Live Search JS -->
    <script src="searchQuest.js"></script>
